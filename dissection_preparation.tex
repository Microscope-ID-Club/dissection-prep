...
\begin{description}
	\item[Label] A label should be placed \textbf{inside the tube} along with a single specimen recording: Who, What, Where, When and How. Figure~\ref{InternalLabel} illustrates how labels are used and why they must be inside the specimen tube.
